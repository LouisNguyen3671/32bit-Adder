...
REM
REM Generated by Vivado on Wed Feb 23 13:43:58 -0600 2022
...
echo "xvlog --incr --relax -prj tb_fa_32_vlog.prj"
call xvlog  --incr --relax -prj tb_fa_32_vlog.prj -log xvlog.log
